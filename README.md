## Added by Y. Zaliznyak

In order to avoid time- and memory consuming data loading one can 
localize the row numbers which correspond to the dates of interest 
by single execution of the following R code. As a result, the only 
rows from 66637 to 69516 are to be read.
